...
```{r}
merged <- merged %>% 
  dplyr::select(player, year, age, ranking, points, tourn_played, matches, percentage_service, percentage_return, games_won_service, games_total_service, games_won_return, games_total_return)
```
